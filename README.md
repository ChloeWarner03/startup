...
- **Web Service** - Uses Savescores to save the hgihest scores of the player and apilayer mailboxlayer ([https://eva.pingutil.com/](https://mailboxlayer.com/)) to validate email addresses of the players when they are making a login
